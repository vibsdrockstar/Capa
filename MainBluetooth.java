...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EnableDisable=(Button)findViewById(R.id.bed);
        Recieve=(Button)findViewById(R.id.brecieve);
//        Send=(Button)findViewById(R.id.button11);
        EnableDiscoverable=(Button)findViewById(R.id.btend);
        Discover=(Button)findViewById(R.id.b_disc);
